...
def main(argv):
  ...
  FileCopy(gvfindtools.llvmBinDir, 'clang', gvfindtoolsdeploy.llvmBinDir ),
  FileCopy(gvfindtools.llvmBinDir, 'opt', gvfindtoolsdeploy.llvmBinDir),
  FileCopy(gvfindtools.llvmBinDir, 'llvm-nm', gvfindtoolsdeploy.llvmBinDir),
  FileCopy(gvfindtools.bugleBinDir, 'bugle', gvfindtoolsdeploy.bugleBinDir),
