...
def main(argv):
  ...
  RegexFileCopy(gvfindtools.llvmBinDir, 'clang(\.exe)', gvfindtoolsdeploy.llvmBinDir ),
  RegexFileCopy(gvfindtools.llvmBinDir, 'opt(\.exe)', gvfindtoolsdeploy.llvmBinDir),
  RegexFileCopy(gvfindtools.llvmBinDir, 'llvm-nm(\.exe)', gvfindtoolsdeploy.llvmBinDir),
  RegexFileCopy(gvfindtools.bugleBinDir, 'bugle(\.exe)', gvfindtoolsdeploy.bugleBinDir),
